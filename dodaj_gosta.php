                        ...
                        <div class="card" style="border-radius: 15px;">
                            <div class="card-body p-4">
                                ...
                                <form action="dodaj_gosta_insert.php" method="post">
                                    ...
                                    <div class="form-outline">
                                        <label class="form-label" for="form3Example1cg"><b>Hišna številka:</b></label>
                                        <input type="number" id="form3Example1cg" class="form-control form-control-lg"
                                            name="hisna_stevilka" />

                                    </div>
                                    <div class="form-outline">
                                        <label class="form-label" for="form3Example1cg"><b>Pošta:</b></label>
                                        <input type="text" id="form3Example1cg" class="form-control form-control-lg"
                                            name="posta" />

                                    </div>
                                    <div class="form-outline">
                                        <label class="form-label" for="form3Example1cg"><b>Poštna številka:</b></label>
                                        <input type="number" id="form3Example1cg" class="form-control form-control-lg"
